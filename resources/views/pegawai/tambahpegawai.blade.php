                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-dark" enctype="multipart/form-data">
                                  <form action="{{ route('postpegawai')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">Nama</label>
                                      <input type="text" class="form-control" name="nama" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="silahkan isi nama">
                                      @error('nama')
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="number" class="form-control" name="notelp" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="08XXXXXX">
                                      @error('notelp')
                                      <div class="alert alert-danger">{{ $message }}</div>
                                      @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <label for="exampleinputEmail" class="form-label">Jenis Kelamin</label><br/>
                                    ...
                                    <div> @error('jenis_kelamin')
                                      <div class="alert alert-danger">{{ $message }}</div>
                                      @enderror</div>

                                    <div class="mb-3">
                                      <label for="exampleInputEmail1" class="form-label">Alamat</label>
                                      <input type="text" class="form-control" name="alamat" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="silahkan isi alamat lengkap">
                                      @error('alamat')
                                      <div class="alert alert-danger">{{ $message }}</div>
                                      @enderror
                                    </div>
