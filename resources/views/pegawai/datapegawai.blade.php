...
<html lang="en">
                                ...
                                <table class="table table-bordered table-dark" id="example">
                                    ...
                                    <tbody>
                                     ...
                                     <tr>
                                        ...
                                        <td>{{  $datapegawai->notelp }}</td>
                                        <td>{{  $datapegawai->jenis_kelamin }}</td>
                                        <td>{{  $datapegawai->alamat }}</td>
                                        <td>
                                            <img src="{{ asset('/fotomahasiswa/'. $datapegawai->foto) }}" alt="" style="width: 80px;" height="80px">
                                        </td>
                                        <td>
                                        <a href="{{ url('/editpegawai/'.$datapegawai->id) }}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="#" class="btn btn-danger destroype" data-id="{{ $datapegawai->id }}" data-nama="{{ $datapegawai->nama }}"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                    </tr>
                                    </tbody>
                                     <?php $no++ ?>
    ...
    <script>
        $('.destroype').click(function(){
            var pegawaiid = $(this).attr('data-id');
            var nama = $(this).attr('data-nama');
            swal({
  title: "Yakin?",
  text: "Kamu ingin menghapus data pegawai ini dengan nama "+nama+" ",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
    window.location = "/destroype/"+pegawaiid+""
