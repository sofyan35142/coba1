                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-dark">
                                  <form action="{{ route('postpembayaran')}}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Jenis HP</label>
                                        <input type="text" value="{{ $datapem->idmerk->id }}" name="handphone_id" hidden>
                                        <input type="text" value="{{ $datapem->idmerk->jenis_barang }}" class="form-control" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Metode Pembayaran</label>
                                        <select class="form-select @error("bayar")is-invalid  @enderror" aria-label="Default select example" name="bayar">
