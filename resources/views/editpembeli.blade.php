...
<html lang="en">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-success table-striped">
                                  <form action="/updatepembeli/{{ $data->id }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <select id='datahp' class="form-select @error("merk")is-invalid  @enderror" aria-label="Default select example" name="merk">
                                          <option value="{{ $data->idmerk->id }}">{{ $data->idmerk->jenis_barang }}</option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id='hargahp' class="form-control" name="harga" id="exampleInputEmail1" aria-describedby="emailHelp" readonly value="{{ $data->harga }}">
    ...
    <script>
        ...
        selection.onchange = function(e){
            ...
            document.getElementById('hargahp').value = harga;
        }
    </script>
</html>
